<div class="pacientes view">
	<div class="page-header">
		<h1><?php echo __('Paciente'); ?> <small>#<?php echo h($paciente['Paciente']['id']); ?></small></h1>
	</div>
	...
	<dl>
		...
		<dd>
			<?php echo h($paciente['Paciente']['logradouro']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($paciente['Paciente']['atividade']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Procedencia'); ?></dt>
		<dd>
			<?php echo h($paciente['Paciente']['procedencia']); ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Orgao Exp'); ?></dt>
		<dd>
			<?php echo h($paciente['Paciente']['orgao_exp']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Responsavel'); ?></dt>
		<dd>
			<?php echo h($paciente['Paciente']['responsavel']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($paciente['Historico'])): ?>
		<table cellpadding = "0" cellspacing = "0">
			...
			<?php foreach ($paciente['Historico'] as $historico): ?>
				<tr>
