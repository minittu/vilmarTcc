<div class="cidades index">
	...
	<tr>
		...
		<td><?php echo h($cidade['Cidade']['estado']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cidade['Cidade']['id']), array(), __('Are you sure you want to delete # %s?', $cidade['Cidade']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
